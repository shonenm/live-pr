...
live-pr                 # Conversation left; Files changed / CodeReview right
                        # c: choose commit; Enter: review it; q then Esc: branch
                        # l: review; q: left from review / quit from left; Shift+Tab: toggle
